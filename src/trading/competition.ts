...
import { BD_ZERO, BI_ONE, BI_ZERO, getNexiPriceInUSD, TRACKED_PAIRS } from "./utils";
...
export function handleUserRegister(event: UserRegister): void {
  ...
  if (competition === null) {
    ...
    competition.volumeNEXI = BD_ZERO;
